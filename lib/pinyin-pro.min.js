!(function (n, i) {
  ...
  const r = 1;
  function e(n) {
    return n.length - ((null == (n = n.match($)) ? void 0 : n.length) || 0);
  }
  function j(n) {
    const i = [];
    let g = 0;
    for (; g < n.length; ) {
      var h = n[g];
      N.test(h) && M.test(n[g + 1])
        ? (i.push(n.substring(g, g + 2)), (g += 2))
        : (i.push(h), (g += 1));
    }
    return i;
  }
  class i {
    ...
    get(n) {
      if (1 < n.length) return this.StringDICT.get(n);
      n = n.charCodeAt(0);
      return this.NumberDICT[n];
    }
    set(n, i) {
      1 < n.length
        ? this.StringDICT.set(n, i)
        : ((n = n.charCodeAt(0)), (this.NumberDICT[n] = i));
    }
    clear() {
  ...
  function y(i, n, g) {
    return (
      (function (n) {
        if ("々" === i) return n && b.get(n) ? b.get(n).split(" ")[0] : "tóng";
      })(n) ||
      (function (n) {
        if (!("了" !== i || (n && b.get(n)))) return "liǎo";
      })(n) ||
      (function (n, i, g) {
        if (-1 === _.indexOf(n)) return f(n);
        if (i === g && i && f(i) !== i) return q(f(n));
        if (g && !U[n].includes(g)) {
          const i = f(g);
          if (i !== g) {
            const g = v(i),
              u = z[n];
            for (var h in u) if (-1 !== u[h].indexOf(Number(g))) return h;
          }
        }
      })(i, n, g) ||
      f(i)
  ...
  const sn = [...Y, ...V, ...K, ...J, ...Q, ...G],
    x = new (class {
      constructor() {
        ((this.dictMap = new Map()),
          (this.queues = []),
          (this.root = new un(null)));
      }
      build(n) {
        ...
        for (var n of g) {
          ...
          for (let n = 0; n < g.length; n++) {
            var h,
              u = g[n];
            (i.children.has(u) ||
              ((h = new un(i, g.slice(0, n).join(""), u)),
              i.children.set(u, h),
              this.addNodeToQueues(h)),
              (i = i.children.get(u)));
          }
          (this.insertPattern(i.patterns, n),
            (n.node = i),
            this.addPatternToDictMap(n));
        }
      }
      buildFailPointer() {
        let h = [],
        ...
        for (
          ...
          let n = h[u++],
            i = n.parent && n.parent.fail,
            g = n.key;
          for (; i && !i.children.has(g); ) i = i.fail;
          n.fail = i ? i.children.get(g) : this.root;
        }
      }
      ...
      addNodeToQueues(n) {
        (this.queues[e(n.prefix)] || (this.queues[e(n.prefix)] = []),
          this.queues[e(n.prefix)].push(n));
      }
      insertPattern(i, g) {
        for (let n = i.length - 1; 0 <= n; n--) {
          ...
          if (g.priority === h.priority && g.probability >= h.probability)
            ...
            if (!(g.priority > h.priority)) return void (i[n + 1] = g);
            i[n + 1] = h;
          }
        }
        i[0] = g;
      ...
      removeDict(n) {
        this.dictMap.has(n) &&
          (this.dictMap.get(n).forEach((i) => {
            i.node.patterns = i.node.patterns.filter((n) => n !== i);
          }),
      ...
      match(n, g) {
        ...
        for (let i = 0; i < s.length; i++) {
          for (var o = s[i]; null !== h && !h.children.has(o); ) h = h.fail;
          if (null === h) h = this.root;
          else {
            const s = (h = h.children.get(o)).patterns.find((n) =>
              "off" === g
                ? 10 !== n.priority
                : "head" !== g || n.length - 1 - i == 0,
            );
            s &&
              u.push(
            ...
            3 === g
              ? function (i, g) {
                  ...
                  for (let n = g - 1; 0 <= n; n--) {
                    for (
                      var o =
                        n + 1 >= g ? { count: 0, patterns: [] } : h[n + 1];
                      s && s.index + s.length - 1 === n;
                    ) {
                      const g = s.index,
                        y = {
                          count:
                            (100 === (t = s).priority
                              ? -t.length * t.length * 1e5
                              : 10 === t.priority
                    ...
                    var z = { count: 1 + o.count, patterns: o.patterns };
                    ((h[n] = hn(h[n], z)),
                      h[n].concatPattern &&
                        ((h[n].patterns = h[n].patterns.concat(
                          h[n].concatPattern,
                        )),
                        (h[n].concatPattern = void 0),
                        delete h[n + 1]));
                  }
                  var t;
              ...
              : function (i, g) {
                  ...
                  for (let n = g - 1; 0 <= n; n--) {
                    for (
                      ...
                      const g = s.index,
                        y = {
                          probability: s.probability * o.probability,
                          decimal:
                            o.decimal +
                            (100 === (t = s).priority
                              ? -t.length * t.length * 100
          ...
          )(i, e(n));
        {
          ...
          for (let i = s.length - 1; 0 <= i; ) {
            ...
            for (
              ...
              ((h = s[i]),
              !(
                (u = s[n]).index + u.length <= h.index ||
                u.priority > h.priority ||
                (u.priority === h.priority && u.length > h.length)
              ));
            )
              n--;
            ((n < 0 || s[n].index + s[n].length <= o) && z.push(s[i]), (i = n));
          }
          return z.reverse();
        }
      }
  ...
  function zn(n, g, h) {
    for (var i in n) {
      ...
      j(i).forEach((n, i) => {
        i = u.split(" ")[i] || "";
        "replace" === h || ("add" === h && !g.get(n) && !b.get(n))
          ? g.set(n, i)
          : (g.set(n, g.get(n) || b.get(n)),
            g.get(n).split(" ").includes(i) ||
              g.set(n, (g.get(n) + " " + i).trim()));
      });
    }
  }
  const f = (n) => {
    ...
    tn = (n, h, u, s) => {
      var i = x.search(n, u, s);
      let o = 0;
      var z = j(n);
      for (let g = 0; g < z.length; ) {
        const u = i[o];
        if (u && g === u.index)
          if (1 === u.length && u.priority <= r) {
            const u = z[g];
            var t = y(u, z[g - 1], z[g + 1]);
            ((h[g] = { origin: u, result: t, isZh: t !== u, originPinyin: t }),
              g++,
              o++);
          } else {
            const s = u.pinyin.split(" ");
            let i = 0;
    ...
    a = (n, i) => {
      ...
      for (var s of g)
        for (var o of B)
          if (s.startsWith(o)) {
            let n = s.slice(o.length);
            (-1 !== R.indexOf(o) && -1 !== W.indexOf(n) && (n = H[n]),
              h.push(o),
              u.push(n));
            break;
          }
  ...
  const S = (i, g) => {
      var n = g.nonZh;
      if ("removed" === n)
        return i.filter((n) => n.isZh || !P(n.origin, g.nonZhScope));
      if ("consecutive" !== n) return i;
      for (let n = i.length - 2; 0 <= n; n--) {
        const h = i[n],
          u = i[n + 1];
        !h.isZh &&
          !u.isZh &&
          P(h.origin, g.nonZhScope) &&
          P(u.origin, g.nonZhScope) &&
          ((h.origin += u.origin), (h.result += u.result), (u.delete = !0));
      }
      return i.filter((n) => !n.delete);
    },
    ln = (n, i) =>
      !(1 !== e(n) || !i.multiple) &&
      ((i, n = "off") => {
        let g = yn(i, n);
        return 0 < g.length
          ? g.map((n) => ({ origin: i, result: n, isZh: !0, originPinyin: n }))
    ...
    cn = (n, i) => {
      switch (i.pattern) {
        ...
        case "num":
          n.forEach((n) => {
            n.result = n.isZh ? v(n.result) : "";
          });
          break;
        case "initial":
          n.forEach((n) => {
            n.result = n.isZh ? a(n.result, i.initialPattern).initial : "";
          });
          break;
        case "final":
          n.forEach((n) => {
            n.result = n.isZh ? a(n.result, i.initialPattern).final : "";
          });
          break;
        case "first":
          n.forEach((n) => {
            n.result = Z(n.result, n.isZh);
          });
          break;
        case "finalHead":
          n.forEach((n) => {
            n.result = n.isZh ? k(n.result).head : "";
          });
          break;
        case "finalBody":
          n.forEach((n) => {
            n.result = n.isZh ? k(n.result).body : "";
          });
          break;
        case "finalTail":
          n.forEach((n) => {
            n.result = n.isZh ? k(n.result).tail : "";
          });
      }
    },
    C = (n, i) => {
  ...
  function A(n, i) {
    if (((i = Object.assign(Object.assign({}, dn), i || {})), !O(n))) return n;
    ...
    let g = Array(e(n)),
      h = tn(n, g, i.surname, i.segmentit)["list"];
    ((h = jn(h, i.toneSandhi)),
      (h = S(h, i)),
      ln(n, i) && (h = ln(n, i)),
      cn(h, i),
      ...
      : "all" === t.type
        ? u.map((n) => {
            const i = n.isZh ? n.result : "",
              { initial: g, final: h } = a(i, t.initialPattern),
              { head: u, body: s, tail: o } = k(i);
            let z = [];
            return (
              "" !== i &&
                (z = [i].concat(
                  yn(n.origin, t.surname).filter((n) => n !== i),
                )),
              {
                origin: n.origin,
                pinyin: i,
                initial: g,
                final: h,
                first: Z(n.result, n.isZh),
                finalHead: u,
                finalBody: s,
                finalTail: o,
                num: Number(v(n.originPinyin)),
                isZh: n.isZh,
                polyphonic: z,
                inZhRange: !!b.get(n.origin),
                result: n.result,
              }
            );
          })
        : u.map((n) => n.result).join(t.separator);
  }
  const F = Symbol("default"),
    E = new Map();
  const rn = {
      precision: "first",
      continuous: !1,
    ...
    en = (g, h, u) => {
      ...
      for (let n = 0; n < o.length; n++)
        if (i && " " === o[n]) s.push(n);
        else if (o[n] === h[0]) ((h = h.slice(1)), s.push(n));
        else {
          const z = A(o[n], {
            toneType: "none",
            multiple: !0,
          ...
          if (
            (z.forEach((n) => {
              n = ((i, g) => {
                let h = 0;
                for (let n = 0; n < i.length; n++) i[n] === g[h] && h++;
                return h;
              })(n, h);
              n > i && (i = n);
            }),
            i && ((h = h.slice(i)), s.push(n)),
            !h)
          )
            break;
        }
      ...
      if (u.continuous) {
        const g = s;
        if (s.some((n, i) => 0 < i && n !== g[i - 1] + 1)) return null;
      }
      return (s = "ignore" === u.space ? s.filter((n) => " " !== o[n]) : s)
        .length
        ? s
        : null;
    },
    ...
    xn = (n) =>
      j(n).map((n) => {
        var i = w.get(n) || b.get(n) || n;
        return { origin: n, result: i, isZh: i !== n, originPinyin: i };
      }),
    mn = { separator: " ", format: "numToSymbol" },
    pn = {
      a: ["a", "ā", "á", "ǎ", "à"],
      o: ["o", "ō", "ó", "ǒ", "ò"],
      e: ["e", "ē", "é", "ě", "è"],
    ...
    wn =
      ((h.OutputFormat = void 0),
      ((n = h.OutputFormat || (h.OutputFormat = {}))[(n.AllSegment = 1)] =
        "AllSegment"),
      ...
      (n[(n.ZhArray = 8)] = "ZhArray"),
      {
        ...
        mode: "normal",
        nonZh: "spaced",
        v: !(n[(n.ZhString = 9)] = "ZhString"),
        separator: " ",
        toneSandhi: !0,
        segmentit: 2,
        format: h.OutputFormat.AllSegment,
      });
  ((h.addDict = function (n, i) {
    const g = [],
      h = ("object" == typeof i ? i.name : i) || F,
      u = (null == i ? void 0 : i.dict1) || "add";
    for (var s in n) {
      var o = n[s],
        z = Array.isArray(o) ? o[0] : o,
        t = e(s);
      if (1 === t) {
        y = void 0;
        l = void 0;
        ...
        E.get(y) || E.set(y, {});
        const d = E.get(y);
        if ((d[l] || (d[l] = b.get(l)), "add" === j)) {
          const y = b.get(l);
          y && !y.split(" ").includes(c)
            ? b.set(l, y + " " + c)
            : b.get(l) || b.set(l, c);
        } else "replace" === j && b.set(l, c);
      }
      Array.isArray(o)
        ? g.push({
            zh: s,
            pinyin: z,
            probability: "number" == typeof o[1] ? o[1] : 2e-8 * t * t,
            length: t,
            priority: r,
            dict: h,
    ...
    (h.clearCustomDict = function (n) {
      (("pinyin" !== n && -1 === n.indexOf("pinyin")) ||
        (Object.keys(m).forEach(function (n) {
          delete m[n];
        }),
        x.removeDict(on)),
        ("multiple" !== n && -1 === n.indexOf("multiple")) || p.clear(),
        ("polyphonic" !== n && -1 === n.indexOf("polyphonic")) || w.clear());
    }),
    (h.convert = function (n, o) {
      o = Object.assign(Object.assign({}, mn), o || {});
      var i = typeof n;
      return (
        (n = (n = "string" == typeof n ? n.split(o.separator) : n).map((n) => {
          var i,
            g = o.format;
          if ("numToSymbol" !== g)
            return "symbolToNum" === g
              ? ((i = n), "" + q(i) + v(i))
              : "toneNone" === g
                ? ((i = n), q(i))
                : n;
          var h = n,
            u = Number(h[h.length - 1]);
          if (0 <= u && u <= 4) {
            for (var s in pn)
              if (h.includes(s))
                return h.slice(0, h.length - 1).replace(s, pn[s][u]);
            return h;
          }
          return h;
        })),
        "string" == i ? n.join(o.separator) : n
      );
    }),
    (h.customPinyin = function (i = {}, n) {
      Object.keys(i)
        .sort((n, i) => e(i) - e(n))
        .forEach((n) => {
          m[n] = i[n];
        });
      var g = Object.keys(m).map((n) => ({
        zh: n,
        pinyin: m[n],
        probability: 1 + e(n),
        length: e(n),
      ...
      (x.build(g),
        null != n && n.multiple && zn(i, p, n.multiple),
        null != n && n.polyphonic && zn(i, w, n.polyphonic));
    }),
    (h.getFinalParts = k),
    (h.getInitialAndFinal = a),
    (h.getNumOfTone = v),
    (h.html = (n, i) => {
      const o = Object.assign(Object.assign({}, D), i || {});
      return A(n, {
        type: "all",
        toneType: o.toneType,
        ...
        .map((n) => {
          let i = "";
          for (const s in o.customClassMap)
            o.customClassMap[s].includes(n.origin) && (i += " " + s);
          var g, h, u;
          return n.isZh
            ? ((g = o.resultClass || D.resultClass),
              (h = o.chineseClass || D.chineseClass),
              (u = o.pinyinClass || D.pinyinClass),
              `<span class="${g}${i}"><ruby><span class="${h}">${n.origin}</span>${o.rp ? "<rp>(</rp>" : ""}<rt class="${u}">${n.pinyin}</rt>${o.rp ? "<rp>)</rp>" : ""}</ruby></span>`)
            : o.wrapNonChinese
              ? `<span class="${o.nonChineseClass || D.nonChineseClass}${i}">${n.origin}</span>`
              : n.origin;
        })
        .join("");
    }),
    (h.match = (n, h, u) => {
      ("any" === (null == u ? void 0 : u.precision) &&
        (u.lastPrecision = "any"),
        null != u && u.v && (h = h.replace(/ü/g, "v")));
      var s = Object.assign(Object.assign({}, rn), u || {});
      (!1 !== s.insensitive && ((n = n.toLowerCase()), (h = h.toLowerCase())),
        "ignore" === s.space && (h = h.replace(/\s/g, "")));
      {
        var o = n,
          z = (
            "any" === (null == u ? void 0 : u.precision)
              ...
              : (n, s, i) => {
                  const g = j(n),
                    o = Array(g.length + 1);
                  for (let n = 0; n < o.length; n++)
                    ((o[n] = Array(s.length + 1)), (o[n][0] = []));
                  for (let n = 0; n < o[0].length; n++) o[0][n] = [];
                  for (let u = 1; u < o.length; u++) {
                    if (
                      !i.continuous ||
                      ("ignore" == i.space && " " === g[u - 1])
                    )
                    ...
                    for (let h = 1; h <= s.length; h++)
                      if (
                        ...
                        if (g[u - 1] === s[h - 1]) {
                          const i = [...o[u - 1][h - 1], u - 1];
                          if (
                            ((!o[u][h] || i.length > o[u][h].length) &&
                              (o[u][h] = i),
                            h === s.length)
                          )
                            return o[u][h];
                        ...
                        if (
                          ...
                          t.some((n) =>
                            "any" === i.lastPrecision
                              ? n.includes(s.slice(h - 1, s.length))
                              : "start" === i.lastPrecision
                                ? n.startsWith(s.slice(h - 1, s.length))
                                : "first" === i.lastPrecision
                                  ? n[0] === s.slice(h - 1, s.length)
                                  : "every" === i.lastPrecision &&
                                    n === s.slice(h - 1, s.length),
                          )
                        )
                          return [...o[u - 1][h - 1], u - 1];
                        var z = i.precision;
                        if (
                          ("start" === z &&
                            t.forEach((n) => {
                              ...
                              for (
                                var g = [...o[u - 1][h - 1], u - 1];
                                i <= s.length &&
                                n.startsWith(s.slice(h - 1, i));
                              )
                                ((!o[u][i] || g.length > o[u][i].length) &&
                                  (o[u][i] = g),
                                  i++);
                            }),
                          "first" === z && t.some((n) => n[0] === s[h - 1]))
                        ) {
                          const s = [...o[u - 1][h - 1], u - 1];
                          (!o[u][h] || s.length > o[u][h].length) &&
                            (o[u][h] = s);
                        }
                        z = t.find(
                          (n) => n === s.slice(h - 1, h - 1 + n.length),
                        );
                        if (z) {
                          const s = [...o[u - 1][h - 1], u - 1],
                            i = h - 1 + z.length;
                          (!o[u][i] || s.length > o[u][i].length) &&
                            (o[u][i] = s);
                        }
                      }
                  }
        ...
        for (let n = 0; n < z.length; n++) {
          for (var y = z[n]; g <= y; ) (2 === t[g].length && i++, g++);
          var l = y + i;
          2 === t[y].length ? c.push(l - 1, l) : c.push(l);
        }
        return c;
      }
    }),
    (h.pinyin = A),
    (h.polyphonic = function (n, i = bn) {
      if (!O(n)) return [];
      if ("" === n) return [];
      ("all" === i.type && (i.pattern = "pinyin"),
        "num" === i.pattern && (i.toneType = "none"),
        ...
        g.map((n) =>
          ((n, z) =>
            "array" === z.type
              ...
              : "all" === z.type
                ? n.map((n) => {
                    var i = n.isZh ? n.result : "",
                      { initial: g, final: h } = a(i, z.initialPattern),
                      { head: u, body: s, tail: o } = k(i);
                    return {
                      origin: n.origin,
                      pinyin: i,
                ...
                : Array.from(new Set(n.map((n) => n.result))).join(" "))(n, i),
        )
      );
    }),
    (h.removeDict = function (n) {
      x.removeDict(n || F);
      {
        n = n || F;
        const g = E.get(n) || {};
        for (var i in g) (b.set(i, g[i]), delete g[i]);
        return;
      }
    }),
    (h.segment = function (n, i) {
      if (((i = Object.assign(Object.assign({}, wn), i || {})), !O(n)))
        return n;
      void 0 === i.surname &&
        ("surname" === i.mode ? (i.surname = "all") : (i.surname = "off"));
      var g = Array(e(n)),
        { list: n, matches: g } = tn(n, g, i.surname, i.segmentit),
        n = jn(n, i.toneSandhi),
        n =
          ((n = S(n, i)),
          C(n, i),
          ...
          (function (i, g) {
            ...
            let u = 0,
              s = 0;
            for (; u < i.length && s < g.length; ) {
              const o = g[s],
                n = i[u];
              if (o.zh.startsWith(n.origin)) {
                const g = u,
                  z = j(o.zh);
                let n = g + 1;
                for (; n < i.length && i[n].origin === z[n - g]; ) n++;
                const t = i.slice(g, n);
                (h.push({
                  segment: t.map((n) => ({
                    origin: n.origin,
                ...
                (h.push({
                  segment: [{ origin: n.origin, result: n.result }],
                  isZh: !1,
                }),
                  u++);
            }
            for (; u < i.length; ) {
              const g = i[u];
              (h.push({
                segment: [{ origin: g.origin, result: g.result }],
                isZh: !1,
              }),
                u++);
            }
        ...
        g = n,
        n = { format: i.format, separator: i.separator },
        { format: n = h.OutputFormat.AllSegment, separator: i = " " } = n;
      if (n === h.OutputFormat.AllSegment)
        return g.map((n) => ({
          origin: n.segment.map((n) => n.origin).join(""),
          result: n.segment.map((n) => n.result).join(""),
        }));
      if (n === h.OutputFormat.AllArray) return g.map((n) => n.segment);
      if (n !== h.OutputFormat.AllString)
        return n === h.OutputFormat.PinyinSegment
          ? g.map((n) => n.segment.map((n) => n.result).join(""))
          : n === h.OutputFormat.PinyinArray
            ? g.map((n) => n.segment.map((n) => n.result))
            : n === h.OutputFormat.PinyinString
              ? g.map((n) => n.segment.map((n) => n.result).join("")).join(i)
              : n === h.OutputFormat.ZhSegment
                ? g.map((n) => n.segment.map((n) => n.origin).join(""))
                : n === h.OutputFormat.ZhArray
                  ? g.map((n) => n.segment.map((n) => n.origin))
                  : n === h.OutputFormat.ZhString
                    ? g
                        .map((n) => n.segment.map((n) => n.origin).join(""))
                        .join(i)
                    : void 0;
      {
        const h = g.map((n) => ({
        ...
        return {
          origin: h.map((n) => n.origin).join(i),
          result: h.map((n) => n.result).join(i),
        };
      }
    }),
